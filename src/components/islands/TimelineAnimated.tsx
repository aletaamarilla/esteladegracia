    ...
    <section className="py-14 md:py-20 lg:py-28 relative overflow-hidden">
      ...
      <div className="container mx-auto px-5 relative">
        ...
        <div className="max-w-3xl mx-auto relative">
          {/* Vertical line */}
          <div className="absolute left-1/2 top-0 bottom-0 w-px -translate-x-1/2 bg-gradient-to-b from-[#98465d] via-[#9591eb] to-[#cfcdff]" />
          ...
          {items.map((item, i) => {
            ...
            return (
              ...
              >
                {/* Dot */}
                <div
                  className={`timeline-dot absolute left-1/2 w-3.5 h-3.5 rounded-full -translate-x-1/2 mt-2 z-10 transition-all duration-700 ${
                    isVisible
                ...
                {/* Content */}
                <div
                  className={`w-[calc(50%-1.75rem)] transition-all duration-700 ${
                    isLeft ? "mr-auto pr-2 text-right" : "ml-auto pl-2"
                  } ${
                    isVisible
